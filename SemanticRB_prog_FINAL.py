...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), September 25, 2015, at 07:09
...
# Setup the Window for experiment
...
if expInfo['frameRate']!=None:
    ...
    frameDur = 1.0/60.0 # if couldn't get a reliable measure, then  guess
...
text_4 = visual.TextStim(win=win, ori=0, name='text_4',
    text='You will be presented with a series of words. Immediately after the end of each trial, please report the words or pictures to the experimenter in order you saw them.\n\nPress the spacebar to begin your practice trials.',    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
text_5 = visual.TextStim(win=win, ori=0, name='text_5',
    text='You have come to the end of the first half of the experiment. You may take a short rest\n\nPress the spacebar when you are ready to commence the second half.',    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb')

# Trial sequence stimuli
trialClock = core.Clock()
ISI = core.StaticPeriod(win=win, screenHz=expInfo['frameRate'], name='ISI')
fixmask1 = visual.TextStim(win=win, ori=0, name='fixmask1',
    text='%%%%%%%',    font='Arial',
...
trials_4 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath='C:\\Users\\Manuel\\Desktop\\Psychopy\\Semantic word experiment.psyexp',
...
for thisTrial_4 in trials_4:
    ...
    frameN = -1
    # update component parameters for each repeat
    dist1a.setText('sleep')
    crit1a.setText('score')
    dist2a.setText('write')
    crit2a.setText('board')
    dist3a.setText('question')
...
# set up handler to look after randomisation of conditions etc
trials_3 = data.TrialHandler(nReps=10, method='random', 
    extraInfo=expInfo, originPath='C:\\Users\\Manuel\\Desktop\\Psychopy\\Semantic word experiment.psyexp',
    trialList=data.importConditions('Numbers Expt Prac Stimuli.xlsx'),
...
for thisTrial_5 in trials_5:
    ...
    #response key to continue at self-pace
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
